 ...
 */
public class hdf5_getters_nigel_ii
{
    ...
    public static void printSong(String fileName)
    {
        ...
        try {
            ...
            int[] resI;
            // metadata
            System.out.print("{\"artistFamiliarity\":\"" + get_artist_familiarity(h5) + "\",");
            System.out.print("\"artistHotttnesss\":\"" + get_artist_hotttnesss(h5) + "\",");
            System.out.print("\"artistID\":\"" + get_artist_id(h5) + "\",");
            System.out.print("\"artistLatitude\":\"" + get_artist_latitude(h5) + "\",");
            System.out.print("\"artistLongitude\":\"" + get_artist_longitude(h5) + "\",");
            System.out.print("\"artistLocation\":\"" + get_artist_location(h5) + "\",");
            System.out.print("\"artistName\":\"" + get_artist_name(h5) + "\",");
            System.out.print("\"album\":\"" + get_release(h5) + "\",");


            // analysis
            System.out.print("\"songTitle\":\"" + get_title(h5)  + "\",");
            System.out.print("\"songDuration\":\"" + get_duration(h5) + "\",");
            System.out.print("\"songKey\":\"" + get_key(h5) + "\",");
            System.out.print("\"songLoudness\":\"" + get_loudness(h5) + "\",");
            System.out.print("\"songBPM\":\"" + get_tempo(h5) + "\",");
            System.out.print("\"songHotttnesss\":\"" + get_song_hotttnesss(h5) + "\",");
            System.out.print("\"songDancibility\":\"" + get_danceability(h5) + "\",");
            System.out.print("\"songEnergy\":\"" + get_energy(h5) + "\",");

            res = get_sections_start(h5);
            System.out.print("\"songSections\":\"" + res.length  + "\",");

            // musicbrainz
            System.out.println("\"songYear\":\"" + get_year(h5) + "\"}");
